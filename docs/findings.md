...
Every logged issue and the tests that confirm it. **72 findings — 53 fixed ·
...
| `WR-` | Walk review, 2026-08-16 — the open register re-executed against the source | `WR-1` |
...
**53 fixed · 4 closed by design · 1 withdrawn — 58 rows.** Permanent: commit messages and
...
**✅ 65 PASS · ❌ 0 FAIL · ➖ 3 n/a — 68 tests in 61 rows** (an `(A)`/`(B)` pair shares a
