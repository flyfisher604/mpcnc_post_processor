...
The hobbyist-side findings register and test register. **51 findings** — 34 `HR-` from the hobbyist
...
## Findings — HR-1 … HR-34 · CR-1 … CR-17
...
## Test register — 95 rows

**✅ 67 PASS · ❌ 0 FAIL · ⬜ 8 UNRUN · ➖ 20 n/a or moved — 95 rows.** Complete by construction: every `H`/`HR`/`HW`
