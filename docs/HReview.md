...
The hobbyist-side findings register and test register. **50 findings** — 33 `HR-` from the hobbyist
...
## Findings — HR-1 … HR-33 · CR-1 … CR-17
...
## Test register — 94 rows

**✅ 67 PASS · ❌ 0 FAIL · ⬜ 7 UNRUN · ➖ 20 n/a or moved — 94 rows.** Complete by construction: every `H`/`HR`/`HW`
